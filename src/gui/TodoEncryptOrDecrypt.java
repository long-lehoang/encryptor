 ...
 * @author Arlene
 */
public class TodoEncryptOrDecrypt extends javax.swing.JFrame
{

    private File[] listFile;
    private String encryptOrDecrypt;
    
    public TodoEncryptOrDecrypt(File[] listOfFilesAndFolders, String encryptOrDecrypt)
    {
        this.listFile = listOfFilesAndFolders;
    ...
    {
        for(Integer i=0, j=1; i < listFile.length; i++, j++)
        {
            listOfFilesAndFoldersTextField.append(j.toString()+". "+listFile[i].getName()+"\n");
            listOfFilesAndFoldersTextField.append(listFile[i].getAbsolutePath()+"\n\n");
        }
    ...
    private void initComponents() {
        ...
        reSelectFilesButton.setText("Cancel");
        ...
        addMoreFilesButton.setText("Add More");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(35, 35, 35)
                                .addComponent(encryptOrDecryptButton, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(reSelectFilesButton, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    {//GEN-HEADEREND:event_encryptOrDecryptButtonActionPerformed
        ...
        if(encryptOrDecrypt.equalsIgnoreCase("encrypt"))
        {
            new PasswordEncryption(listFile).setVisible(true);
        }
        else if(encryptOrDecrypt.equalsIgnoreCase("decrypt"))
        {
            new PasswordDecryption(listFile).setVisible(true);
        }
