...
public class FileChooser extends javax.swing.JFrame
{
    ...
    public FileChooser(String encryptOrDecrypt, File[] listFile)
    {
        this.encryptOrDecrypt=encryptOrDecrypt;
    ...
    private boolean allAreEncFiles(File[] listFile)
    {
       for(File file:listFile)
        {
            String filePath=file.getAbsoluteFile().toString();
    ...
    {//GEN-HEADEREND:event_jFileChooser1ActionPerformed
        ...
        else if(evt.getActionCommand().toString().equals("ApproveSelection"))
        {
            ...
            if(!addingNewFilesToExisting)
            {
                this.listFile=jFileChooser1.getSelectedFiles();
            }
            
            else if(addingNewFilesToExisting)
            {
                File[] newListFile=jFileChooser1.getSelectedFiles();
             
                
                int newLength= newListFile.length+this.listFile.length;
                ...
                {
                    combinedFileArray[i]=this.listFile[i];
                }
                for(int j=0; j<newListFile.length; j++)
                {
                    combinedFileArray[i++]=newListFile[j];
                }
                
                this.listFile = combinedFileArray;
            }
